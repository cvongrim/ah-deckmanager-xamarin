...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"n_onFailedToRecycleView:(Landroid/support/v7/widget/RecyclerView$ViewHolder;)Z:GetOnFailedToRecycleView_Landroid_support_v7_widget_RecyclerView_ViewHolder_Handler\n" +
	...
	public boolean onFailedToRecycleView (android.support.v7.widget.RecyclerView.ViewHolder p0)
	{
		return n_onFailedToRecycleView (p0);
	}

	private native boolean n_onFailedToRecycleView (android.support.v7.widget.RecyclerView.ViewHolder p0);
