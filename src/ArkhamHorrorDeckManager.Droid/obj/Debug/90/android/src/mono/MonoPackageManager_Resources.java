...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "ArkhamHorrorDeckManager.Droid.dll" comes first in this list. */
		"ArkhamHorrorDeckManager.Droid.dll",
		"ArkhamHorrorDeckManager.Core.dll",
		"MvvmCross.dll",
		...
		"MvvmCross.Plugin.FieldBinding.dll",
