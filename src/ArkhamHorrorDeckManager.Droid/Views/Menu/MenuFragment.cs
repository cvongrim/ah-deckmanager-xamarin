...
using ArkhamHorrorDeckManager.Core.ViewModels.Menu;
using ArkhamHorrorDeckManager.Droid.Views.Helpers;

namespace ArkhamHorrorDeckManager.Droid.Views.Menu
{
        ...
        public bool OnNavigationItemSelected(IMenuItem menuItem)
        {
            switch (menuItem.ItemId)
            {
                case Resource.Id.nav_home:
                    ...
                    break;
                case Resource.Id.nav_decks:
                    ViewModel.ShowDecksCommand.Execute();
                    break;
